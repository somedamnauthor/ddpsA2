...
class FileHandler(object):
    ...
    def initiate_file_split(self, split_index, index):
        ...
        """
        file_split = open(fileNameRetriever.get_input_split_file(split_index-1), "w+")
...
class MapReduce(object):
    ...
    def __init__(self, input_dir = fileNameRetriever.default_input_dir, output_dir = fileNameRetriever.default_output_dir,
                 n_mappers = fileNameRetriever.default_n_mappers, n_reducers = fileNameRetriever.default_n_reducers,
                 clean = True):
        """
        ...
        self.clean = clean
        self.file_handler = FileHandler(fileNameRetriever.get_input_file(self.input_dir), self.output_dir)
